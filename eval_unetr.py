...
# This code proceeds with evaluation using the weights generated by learning. The performance is conducted twice with GPU and CPU.
root_dir = '/home/dgxadmin/workspace/hjy_workspace/unetr/workspace/hjy_workspace/unetr/' # Write the directory of UNETR
